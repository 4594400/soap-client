 ...
 * 
 */
@WebServiceClient(name = "ProcessorImplService", targetNamespace = "http://app.ws.com/", wsdlLocation = "http://127.0.0.1:8081/myWs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PROCESSORIMPLSERVICE_QNAME = new QName("http://app.ws.com/", "ProcessorImplService");
     ...
     * 
     * @return
     *     returns ProcessorImpl
     */
    @WebEndpoint(name = "ProcessorImplPort")
    public ProcessorImpl getProcessorImplPort() {
        return super.getPort(new QName("http://app.ws.com/", "ProcessorImplPort"), ProcessorImpl.class);
    }
    ...
    public ProcessorImpl getProcessorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://app.ws.com/", "ProcessorImplPort"), ProcessorImpl.class, features);
    }
